class UI {
  static addSikayetToUI(newSikayet) {
    ...
    <td>${"Şikayet Devam Ediyor"}</td> 
                //  <td><a href="#" id = "delete-film" class = "btn text-danger  fluit-right">Şikayet Sil</a></td>
                 <td> <a href="#" id = "delete-film" class = "btn text-danger  fluit-right">Şikayet Sil</a></td>
